...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    images: [
      {
        src: "/images/cafe/cafe-v1.png",
        alt: "Cafe concept V1 preview",
        caption: "Cafe Website Concept V1",
        isReal: true,
        aspectClass: "aspect-[16/9]",
      },
    ],
  },
  {
    ...
    images: [
      {
        src: "/images/cafe/cafe-v2.png",
        alt: "Cafe concept V2 preview",
        caption: "Cafe Website Concept V2",
        isReal: true,
        aspectClass: "aspect-[16/9]",
      },
    ],
    ...
    images: [
      {
        ...
        alt: "Version 01 preview",
        caption: "Version 01 live deployment",
        isReal: true,
        aspectClass: "aspect-[16/9]",
      },
    ],
    ...
    images: [
      {
        ...
        alt: "Version 02 preview",
        caption: "Version 02 live deployment",
        isReal: true,
        aspectClass: "aspect-[16/9]",
      },
    ],
  },
  {
    ...
    images: [
      {
        src: "/images/version-03.png",
        alt: "Version 03 preview",
        caption: "Version 03 live deployment",
        isReal: true,
        aspectClass: "aspect-[16/9]",
      },
    ],
